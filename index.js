...
require("appdynamics").profile({
  ...
  controllerPort: process.env.controllerPort || 8090, 
  controllerSslEnabled: process.env.controllerSslEnabled || false,
  accountName: process.env.accountName || 'customer1',
